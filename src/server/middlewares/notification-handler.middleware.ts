...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'Order.update': { roles: ['tenant-roles'], key: 'order_123', tenantPath: [], userPath: [] },
  'Order.delete': { roles: ['tenant-roles', 'tenant-owner-roles'], key: 'order_123', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['owner'];
const customerRoles: string[] = ['guest'];
const tenantRoles: string[] = ['owner', 'team-member'];
